...
public class Program {
    ...
    private static void showMenu(Zooo animals, Scanner input) {
    ...
    private static void addAnimal(Zooo animals, Scanner input) {
    ...
    private static void removeAnimal(Zooo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", Zooo.allAnimal.size());
        System.out.print("Введите цифру кого хотите удалить: ");
        int choice = input.nextInt();
        if (choice < Zooo.allAnimal.size()) {
    ...
    private static void infoAnimal(Zooo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", Zooo.allAnimal.size());
    ...
    private static void sayAnimal(Zooo animal, Scanner input) {
        animal.showAll();
        System.out.printf("%d) Назад\n", Zooo.allAnimal.size());
